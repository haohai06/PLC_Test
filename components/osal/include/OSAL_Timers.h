...
#include "hal_type.h"
	...
	* MACROS
	*/
#define TIM_DLY_NONE 0u
#define TIM_DLY_10MS 10u
#define TIM_DLY_20MS 20u
#define TIM_DLY_50MS 50u
#define TIM_DLY_100MS 100u
#define TIM_DLY_200MS 200u
#define TIM_DLY_500MS 500u
#define TIM_DLY_1S 1000u
#define TIM_DLY_2S 2000u
#define TIM_DLY_3S 3000u
#define TIM_DLY_5S 5000u
#define TIM_DLY_10S 10000u
#define TIM_DLY_30S 30000u
#define TIM_DLY_INVALID 0xFFFFFFFFu
...
//#define OSAL_TIMERS_MAX_TIMEOUT 0x28f5c28e /* unit is ms*/
	...
	*/
	...
	/*********************************************************************
	* 
	*  osal_get_timer_active
	*/
	uint16_t osal_get_timer_active(uint8_t task_id);
	...
	* Adjust timer tables
	*/
	extern void osal_adjust_timers(uint32_t time);
